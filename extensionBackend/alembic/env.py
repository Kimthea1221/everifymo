...
# Override the sqlalchemy.url from alembic.ini with our migrations URL from .env
config.set_main_option("sqlalchemy.url", os.environ["MIGRATIONS_DATABASE_URL"])
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_extension",
    )
