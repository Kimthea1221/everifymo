...
widget:
- source_sentence: BYS pod
  sentences:
  - BYS pearl pod
  - Babyflo baby wipes
  - NIVEA nivea creme
- source_sentence: scrub
  sentences:
  - DERMACEUTIC d scrub
  - PRIME color 13 12
  - JINGHUI perfume
- source_sentence: LAKME 20
  sentences:
  - SPAN spansolo n
  - MUDRA body wash
  - LAKME gloss 10 20
- source_sentence: nars blush
  sentences:
  - WINEY baby wipes
  - NARS nars blush
  - SHIRO aha serum
- source_sentence: KEIJI soap
  sentences:
  - SHEPARD guardian
  - IDEOLOGY shampoo
  - KEIJI keiji soap
...
print(similarities)
# tensor([[ 1.0000,  0.7859,  0.1600],
#         [ 0.7859,  1.0000, -0.0040],
#         [ 0.1600, -0.0040,  1.0000]])
```
<!--
...
* Approximate statistics based on the first 100 samples:
  ...
  | modality | text                                                                              | text                                                                              |                                                                |
  | details  | <ul><li>min: 3 tokens</li><li>mean: 11.63 tokens</li><li>max: 24 tokens</li></ul> | <ul><li>min: 7 tokens</li><li>mean: 14.56 tokens</li><li>max: 32 tokens</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.59</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                    | sentence_1                                                                                       | label            |
  |:--------------------------------------------------------------|:-------------------------------------------------------------------------------------------------|:-----------------|
  | <code>luxe organix papaya kojci acid soap</code>              | <code>LUXE ORGANIX luxe organix papaya kojic acid cloud soap</code>                              | <code>1.0</code> |
  | <code>SKIN LIGHT BOODY CARE power whitening set cream</code>  | <code>SKIN LIGHT BODY CARE rejuvenating power whitening set econo pack rejuvenating cream</code> | <code>1.0</code> |
  | <code>beauty glazed mix match pressed powder eyeshadow</code> | <code>BENCH/BEAUTY bench beauty eyeshadow palette</code>                                         | <code>0.0</code> |
