...
async def request_new_invite(
    ...
    user_email, new_token = request_new_superadmin_invite(db, payload.token, request=http_request)
    background_tasks.add_task(send_superadmin_invite_email, user_email, new_token)
